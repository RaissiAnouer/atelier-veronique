      ...
      <div className="w-full relative py-3 border-y border-gray-200 mt-3 flex items-center">
        ...
        >
          ...
          <img
            ...
            className={`transition-transform duration-200 ease-in-out h-2 w-2 ${openFilter ? "rotate-180" : "rotate-0"} `}
            alt=""
          />
        </button>
        <p className="text-sm cursor-pointer mr-12 text-xs text-gray-400 hover:text-gray-600">
          FILTER
        </p>
      </div>
